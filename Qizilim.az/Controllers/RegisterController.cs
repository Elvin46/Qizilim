...
namespace Qizilim.az.Controllers
{
    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterFormModel registerVM)
        {
            ...
            if (existUser != null)
            {
                ModelState.AddModelError("Username", "Bu Istifadeci adi artiq var.Yeni bir IstifadeciAdi qeyd edin.");
                return View();
            }
            if (registerVM.PhoneNumber.Length != 9)
            {
                ModelState.AddModelError("PhoneNumber", "Telefon Nomresi 9 reqem olmalidir");
                return View();
            }
